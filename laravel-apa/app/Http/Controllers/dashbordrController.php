...
class dashbordrController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $pengaduan = Pengaduan::where('nik', $nik)->paginate($jumlah);
        if(strlen($katakunci))
        {
            $pengaduan=Pengaduan::where('nik','like',"%$katakunci%")
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'foto'  => 'required|mimes:jpeng,jpg,png'

        ],[
            'isi_laporan.required' => 'pengaduan wajib di isi!',
            'foto.required' => 'silakan pilih foto!',
            'foto.mimes' => 'foto hanya mengugunkan ekstensi jpg,jpeng dan png',
        ]);
